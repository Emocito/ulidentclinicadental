  ...
  const injectMobileStickyCta = () => {
    ...
    stickyCta.innerHTML = `
      <div class="flex items-center gap-3 flex-shrink-0">
        <!-- Llamar -->
        <a href="tel:+34910248447" class="w-11 h-11 rounded-full bg-brand-bluelight hover:bg-blue-100 text-brand-blue flex items-center justify-center transition-colors border border-brand-blue/10" aria-label="Llamar por teléfono">
          <i data-lucide="phone" class="w-5 h-5 text-brand-blue"></i>
        </a>

        <!-- WhatsApp -->
        <a href="https://wa.me/34679926552" target="_blank" rel="noopener noreferrer" class="w-11 h-11 rounded-full bg-[#25D366] hover:bg-[#20BA56] text-white flex items-center justify-center transition-all duration-300 hover:scale-105 shadow-sm" aria-label="Contactar por WhatsApp">
      ...
      <!-- Pedir Cita -->
      <a href="index.html#reserva" class="h-11 bg-brand-blue hover:bg-brand-bluedark text-white rounded-full flex items-center justify-center font-heading font-extrabold text-xs uppercase tracking-wider transition-all duration-300 px-5 shadow-md hover:shadow-lg">
